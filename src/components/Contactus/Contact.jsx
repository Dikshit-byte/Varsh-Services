  ...
  return (
    ...
    <section className="contact section" id="contact" style={{margin:"15px"}}>
      ...
      <div className="contact_container container grid">
        <div>
          <a href="mailto:connect@agbiztech.in" target="_blank" rel="noreferrer">
            <div className="contact_info">
              <i className="uil uil-envelope-alt contact_icon"></i>
              <div>
                <h3 className="contact_title">Email</h3>
                <span className="contact_subtitle">connect@agbiztech.in</span>
              </div>
            </div>
          </a>
          ...
          <a href="https://twitter.com/VarshServices?t=Tz-Us3n7HYpV1SA_peMfQg&s=08">
            <div className="contact_info">
              ...
              <div>
                ...
                <span className="contact_subtitle">AGBiz Technologies</span>
              </div>
            </div>
          </a>
